  ...
  return (
    <div className="min-h-screen bg-slate-50">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <div className="text-sm text-slate-600">Praias Catalogadas</div>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <div className="text-sm text-slate-600">Trilhas Disponíveis</div>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <div className="text-sm text-slate-600">Passeios de Lancha</div>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <div className="text-sm text-slate-600">Guias Certificados</div>
              </CardContent>
            </Card>
          </div>
        </div>
      ...
      {recentItineraries && recentItineraries.length > 0 && (
        <section className="py-12">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-slate-800 mb-8">Seus Roteiros Recentes</h2>
